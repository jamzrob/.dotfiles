...
_G.packer_plugins = {
  ...
  ["nvim-autopairs"] = {
    loaded = true,
    path = "/Users/jraubenheimer/.local/share/nvim/site/pack/packer/start/nvim-autopairs",
  ...
  ["nvim-ts-autotag"] = {
    loaded = true,
    path = "/Users/jraubenheimer/.local/share/nvim/site/pack/packer/start/nvim-ts-autotag",
  ...
  ["vim-oscyank"] = {
    loaded = true,
    path = "/Users/jraubenheimer/.local/share/nvim/site/pack/packer/start/vim-oscyank",
